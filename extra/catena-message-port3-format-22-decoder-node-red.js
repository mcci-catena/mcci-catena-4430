...
Name:   catena-message-port3-format-22-decoder-node-red.js

Function:
    Decode port 0x03 format 0x22 messages for Node-RED.
...
// this could be `#include "catena-message-port3-format-22-decoder-ttn.js"`
...
// end of insertion of catena-message-port3-format-22-decoder-ttn.js
...
if (result === null) {
    ...
    var eMsg = "not port 3/fmt 0x22! port=" + msg.port.toString();
    if (port === 3) {
