...
Name:   catena-message-port1-format-23-decoder-node-red.js

Function:
    Decode port 0x01 format 0x23 messages for Node-RED.
...
// this could be `#include "catena-message-port1-format-23-decoder-ttn.js"`
...
msg.local =
    {
        ...
        radioType: "Murata",
        applicationName: "Activity sensor fmt 0x23"
    };
